...
import com.project.classifier4J.vector.HashMapTermVectorStorage;
import com.project.classifier4J.vector.TermVectorStorage;
import com.project.classifier4J.vector.VectorClassifier;
...
public class Compare {
	...
	public double getResult(){
		...
		if (ta.countTokens()==1){
			File f = new File("D:\\piyush code\\semantic search\\SourceCode\\sematiccode\\WORDS\\WORDS"+Character.toString(a.charAt(0))+"/"+a+"/"+a+".txt");
			if(!f.exists()) {return -1;}
		}
		if (tb.countTokens()==1){
			File f = new File("C:/Users/Bhaveshs/Desktop/WORDS/"+Character.toString(b.charAt(0))+"/"+b+"/"+b+".txt");
			if(!f.exists()) {return -1;}	
		}
	...
	private String read(String g){
		try {
		String filename = "C:/Users/Bhaveshs/Desktop/WORDS/"+Character.toString(g.charAt(0))+"/"+g+"/"+g+".txt";
